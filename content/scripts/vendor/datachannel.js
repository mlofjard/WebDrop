...
(function () {
    ...
    function DataConnector(root, config) {
        ...
        function newPrivateSocket(_config) {
            ...
            function transformOutgoing(sdp) {
                console.log(sdp);
            ...
            function sendsdp(sdp) {
                sdp = transformOutgoing(JSON.stringify(sdp));
            ...
            send: function (message, _channel) {
                ...
                if (_channel) _channel.send(data);
                  ...
                  try {
                    ...
                    console.log('Error: Tried to send, but failed.');
                  }   
                }
            },
